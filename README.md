...
**ผู้ขาย (Dashboard UI):** สถิติร้านค้า, CRUD สินค้า + อัปรูป + จัดการตัวเลือกไซส์/สีพร้อมสต็อกแยกตามแบบ, จัดการคำสั่งซื้อ/เปลี่ยนสถานะ (แจ้งเตือนผู้ซื้ออัตโนมัติ), แชทกับลูกค้า, การแจ้งเตือน
